...
def run():
    ...
    img = Image.open('App/Logo/AI RESUME ANALYZER.png')
    st.image(img)
    st.sidebar.markdown("# Choose Something...")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built with 🤍 by <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: #021659;">Career Craft</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https:/" style="text-decoration: none; color: grey;">Siddhesh Patil</a> through 
            <a href="https://www." style="text-decoration: none; color: grey;">Prajkta mam</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Siddhesh! Total %d " % values + " User's Have Used Our Tool : )")                
